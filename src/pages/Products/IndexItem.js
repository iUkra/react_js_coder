            ...
            <div>
              <Header>
                <Link to={`products/${product.id}`}>
                  <h4 style={{ justifyContent: 'center', display: 'flex' }}>{product.title}</h4>
                </Link>
              </Header>
              <Divider clearing />
              <Link to={`products/${product.id}`}>
